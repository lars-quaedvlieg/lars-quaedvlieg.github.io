...
importance: 95
category: "Research"
developedDate: "2024-07-17 16:00:00-0000"
visible: true
---
...
<object data="/assets/pdf/mnlp_project.pdf" type="application/pdf" class="w-full rounded-lg border" style="height: 80vh">
  <p>View the PDF <a href="/assets/pdf/mnlp_project.pdf">here</a>.</p>
</object>

### Progress Report

<object data="/assets/pdf/mnlp_progress.pdf" type="application/pdf" class="w-full rounded-lg border" style="height: 80vh">
  <p>View the PDF <a href="/assets/pdf/mnlp_progress.pdf">here</a>.</p>
</object>

### Project Proposal

<object data="/assets/pdf/mnlp_proposal.pdf" type="application/pdf" class="w-full rounded-lg border" style="height: 80vh">
  <p>View the PDF <a href="/assets/pdf/mnlp_proposal.pdf">here</a>.</p>
</object>
