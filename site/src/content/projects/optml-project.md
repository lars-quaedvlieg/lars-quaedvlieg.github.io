...
<object data="/assets/pdf/optml_project.pdf" type="application/pdf" class="w-full rounded-lg border" style="height: 80vh">
  <p>View the PDF <a href="/assets/pdf/optml_project.pdf">here</a>.</p>
</object>
